...
p1h = plot(issue68B316Ready ? c1 + half : na, "B316 OBS BREAK top", color=color.new(colNeutral, 100))
p1l = plot(issue68B316Ready ? c1 - half : na, "B316 OBS BREAK bottom", color=color.new(colNeutral, 100))
p2h = plot(issue68B316Ready ? c2 + half : na, "B316 SHADOW BREAK top", color=color.new(colNeutral, 100))
p2l = plot(issue68B316Ready ? c2 - half : na, "B316 SHADOW BREAK bottom", color=color.new(colNeutral, 100))
p3h = plot(issue68B316Ready ? c3 + half : na, "B316 OBS RAW top", color=color.new(colNeutral, 100))
p3l = plot(issue68B316Ready ? c3 - half : na, "B316 OBS RAW bottom", color=color.new(colNeutral, 100))
p4h = plot(issue68B316Ready ? c4 + half : na, "B316 SHADOW RAW top", color=color.new(colNeutral, 100))
p4l = plot(issue68B316Ready ? c4 - half : na, "B316 SHADOW RAW bottom", color=color.new(colNeutral, 100))
p5h = plot(issue68B316Ready ? c5 + half : na, "B316 STALE OVERLAP top", color=color.new(colNeutral, 100))
p5l = plot(issue68B316Ready ? c5 - half : na, "B316 STALE OVERLAP bottom", color=color.new(colNeutral, 100))
p6h = plot(issue68B316Ready ? c6 + half : na, "B316 NEW RANGE top", color=color.new(colNeutral, 100))
p6l = plot(issue68B316Ready ? c6 - half : na, "B316 NEW RANGE bottom", color=color.new(colNeutral, 100))
p7h = plot(issue68B316Ready ? c7 + half : na, "B316 BREAK RELEASE top", color=color.new(colNeutral, 100))
p7l = plot(issue68B316Ready ? c7 - half : na, "B316 BREAK RELEASE bottom", color=color.new(colNeutral, 100))
p8h = plot(issue68B316Ready ? c8 + half : na, "B316 RAW ADVANCE top", color=color.new(colNeutral, 100))
p8l = plot(issue68B316Ready ? c8 - half : na, "B316 RAW ADVANCE bottom", color=color.new(colNeutral, 100))
p9h = plot(issue68B316Ready ? c9 + half : na, "B316 BREAK BLOCKER top", color=color.new(colNeutral, 100))
p9l = plot(issue68B316Ready ? c9 - half : na, "B316 BREAK BLOCKER bottom", color=color.new(colNeutral, 100))
...
if barstate.islast
    if showIssue68B316Legend
        table.cell(issue68B316Legend, 0, 0, "LAYER", text_color=color.white, bgcolor=color.new(colNeutral, 15))
        table.cell(issue68B316Legend, 1, 0, "NOW", text_color=color.white, bgcolor=color.new(colNeutral, 15))
        table.cell(issue68B316Legend, 0, 1, "TARGET", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 1, issue68B316Direction, text_color=color.white)
        table.cell(issue68B316Legend, 0, 2, "STALE OVERLAP", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 2, f_issue68B316YN(issue68B316Overlap), text_color=color.white, bgcolor=issue68B316Overlap ? color.new(color.yellow, 8) : color.new(colNeutral, 55))
        table.cell(issue68B316Legend, 0, 3, "OBS BREAK", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 3, issue68B316ObsBreak > 0 ? "TARGET" : issue68B316ObsBreak < 0 ? "OLD" : "ZERO", text_color=color.white, bgcolor=f_issue68B316Sign(issue68B316ObsBreak))
        table.cell(issue68B316Legend, 0, 4, "SHADOW BREAK", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 4, issue68B316ShadowBreak > 0 ? "TARGET" : issue68B316ShadowBreak < 0 ? "OLD" : "ZERO", text_color=color.white, bgcolor=f_issue68B316Sign(issue68B316ShadowBreak))
        table.cell(issue68B316Legend, 0, 5, "OBS RAW", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 5, issue68B316ObsRaw > 0 ? "TARGET" : issue68B316ObsRaw < 0 ? "OLD" : "ZERO", text_color=color.white, bgcolor=f_issue68B316Sign(issue68B316ObsRaw))
        table.cell(issue68B316Legend, 0, 6, "SHADOW RAW", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 6, issue68B316ShadowRaw > 0 ? "TARGET" : issue68B316ShadowRaw < 0 ? "OLD" : "ZERO", text_color=color.white, bgcolor=f_issue68B316Sign(issue68B316ShadowRaw))
        table.cell(issue68B316Legend, 0, 7, "NEW RANGE", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 7, f_issue68B316YN(issue68B316NewRange), text_color=color.white)
        table.cell(issue68B316Legend, 0, 8, "BREAK RELEASE", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 8, f_issue68B316YN(issue68B316ReleasedBreak), text_color=color.white)
        table.cell(issue68B316Legend, 0, 9, "RAW ADVANCE", text_color=color.white, bgcolor=color.new(colNeutral, 45))
        table.cell(issue68B316Legend, 1, 9, f_issue68B316YN(issue68B316AdvancedRaw), text_color=color.white)
    else
...
def generate(source: Path) -> str:
    ...
    if d1.count(phase_b.D1_EXPORT_MARKER) != 1:
        raise RuntimeError("expected one D1 export marker")
    core = d1.split(phase_b.D1_EXPORT_MARKER, 1)[0].rstrip()
    ...
    for token in (
        ...
        if token not in out:
            raise RuntimeError(f"missing {token}")
    for token in ("strategy.", "D1B|"):
        if token in out:
            raise RuntimeError(f"forbidden token {token}")
    if ";" in BODY:
        raise RuntimeError("B3.16 Pine diagnostic body must not contain semicolon statement separators")
    return out
