...
The original generator's assignment locator treated Pine equality checks (`==`)
as if they were assignments because its regex matched the first `=`. This driver
patches only that parser helper, then delegates all Phase A-D transformations to
the frozen generator implementation.
"""
